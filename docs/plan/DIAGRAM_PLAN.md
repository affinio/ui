Цель
  ...
  - Editor must-have slice: implemented in core and the Vue demo with clipboard import/export/duplicate, id remapping, z-order/layer commands, resize commands, waypoint edits, keyboard helpers, additive/toggle/containment selection modes, lock constraints, fit helpers, capability checks, and diagnostics/perf counters.
  ...
  - metrics: initial render, pan FPS, drag latency, selection latency, memory, Vue component count;
