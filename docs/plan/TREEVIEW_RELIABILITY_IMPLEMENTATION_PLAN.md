...
2026-09-19: T10 consumer gate продвинут: @affino/treeview-core tarball установлен в изолированный Node24 consumer вместе с registry @affino/projection-engine@0.2.2 и успешно импортирован/использован без workspace aliases. Browser-native fixture gate остаётся открытым.
