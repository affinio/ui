...
const WORKSPACE_ALIAS_TARGETS: Record<string, string> = {
  ...
  "@affino/datagrid-core/pro": "packages/datagrid-core/src/pro.ts",
  ...
  "@affino/datagrid-vue/pro": "packages/datagrid-vue/src/pro.ts",
  ...
  "@affino/datagrid-pro": "packages/datagrid-pro/src/index.ts",
