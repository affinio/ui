...
function resolvePosition(anchor: Rect, surface: Rect, side: Side, alignment: Alignment, gutter: number) {
...
function measureOverflow(left: number, top: number, surface: Rect, config: NormalizedOptions) {
