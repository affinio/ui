import type { EventHandler, PointerEventLike, Point, Rect, SurfaceCallbacks, SurfaceOptions, SurfaceState, SurfaceSubscriber } from "@affino/surface-core";
export type { Point, Rect, Placement, Alignment, PositionOptions, PositionResult, PointerMeta, PointerEventLike, EventHandler, Subscription, } from "@affino/surface-core";
