...
<template>
  <section class="menu-demo-block">
    <div class="menu-demo-description">
      ...
      <h3 class="menu-demo-title">Open the menu and make repeated picks.</h3>
      <p class="menu-demo-text">The live command flow comes first. Code and notes stay collapsed.</p>
    </div>
    ...
    <QuickDetails title="Code and key points" hint="Open to inspect starter code, CSS, and command-menu notes.">
