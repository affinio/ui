...
<template>
  <section class="menu-demo-block">
    <div class="menu-demo-description">
      ...
      <h3 class="menu-demo-title">Open the menu and move into the nested branch.</h3>
      <p class="menu-demo-text">Code and behavior notes are hidden below.</p>
    </div>
    ...
    <QuickDetails title="Code and key points" hint="Open to inspect starter code, CSS, and nested-menu notes.">
